...
save_restoreSet_status_prefix("zzz:")
dbLoadRecords("$(AUTOSAVE)/asApp/Db/save_restoreStatus.db", "P=zzz:, DEAD_SECONDS=5")
...
set_pass0_restoreFile("auto_positions.sav", "P=zzz:")
# Save positions every five seconds
doAfterIocInit("create_monitor_set('auto_positions.req',5,'P=zzz:')")

set_pass0_restoreFile("auto_settings.sav", "P=zzz:")
set_pass1_restoreFile("auto_settings.sav", "P=zzz:")
# save settings every thirty seconds
doAfterIocInit("create_monitor_set('auto_settings.req',30,'P=zzz:')")

# Note that you can reload these sets after creating them: e.g., 
# reload_monitor_set("auto_settings.req",30,"P=zzz:")
...
#set_pass0_restoreFile("myGenericData.sav", "P=zzz:")
#set_pass1_restoreFile("myGenericData.sav", "P=zzz:")
...
set_requestfile_path("$(SOFTGLUEZYNQ)", "softGlueApp/Db")
set_requestfile_path("$(STD)", "stdApp/Db")
#set_requestfile_path("$(VAC)", "vacApp/Db")
#set_requestfile_path("$(VME)", "vmeApp/Db")
set_requestfile_path("$(TOP)", "zzzApp/Db")
